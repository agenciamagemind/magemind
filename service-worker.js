const CACHE_NAME='magemind-shell-20260915-1';
const SHELL=['./','./index.html','./mobile.css','./auth.css','./goals.css','./goals.js','./mobile-app.js','./app-core.js','./app-accessibility.js','./push-notifications.js','./manifest.webmanifest','./magemind-logo-transparent.png','./magemind-logo-192.png','./magemind-logo-512.png','./magemind-auth-creatives.webp'];
