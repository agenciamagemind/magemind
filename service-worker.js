const CACHE_NAME='magemind-shell-20260915-2';
const SHELL=['./','./index.html','./mobile.css','./auth.css','./goals.css','./goals.js','./security-rich-text.css','./security-rich-text.js','./mobile-app.js','./app-core.js','./app-accessibility.js','./push-notifications.js','./manifest.webmanifest','./magemind-logo-transparent.png','./magemind-logo-192.png','./magemind-logo-512.png','./magemind-auth-creatives.webp'];
