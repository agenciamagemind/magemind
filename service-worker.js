const CACHE_NAME='magemind-shell-20260828-2';
const SHELL=['./','./index.html','./mobile.css','./mobile-app.js','./push-notifications.js','./manifest.webmanifest','./magemind-logo-192.png','./magemind-logo-512.png'];
