...
test('all shipped JavaScript parses',()=>{
 ...
 for(const path of ['goals.js','mobile-app.js','app-core.js','app-accessibility.js','push-notifications.js','service-worker.js'])new vm.Script(fs.readFileSync(path,'utf8'));
});
