...
test('all shipped JavaScript parses',()=>{
 ...
 for(const path of ['partner-workspace.js','partners.js','product-ui.js','goals.js','tasks.js','security-rich-text.js','mobile-app.js','app-core.js','app-accessibility.js','push-notifications.js','service-worker.js'])new vm.Script(fs.readFileSync(path,'utf8'));
});
